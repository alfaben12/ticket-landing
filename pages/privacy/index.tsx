...
const PrivacyPage = () => {
    return (
        <div>
            <NavHeader />
            <p>
                At GET Twin, accessible from get-twin.com, one of our main
                priorities is the privacy of our visitors. This Privacy Policy
                document contains types of information that is collected and
                recorded by GET Twin and how we use it.
            </p>
            ...
            <p>
                GET Twin follows a standard procedure of using log files. These
            ...
            <p>
                Like any other website, GET Twin uses &quot;cookies&quot;. These
            ...
            <p>
                ...
                the advertising partners of GET Twin.
            </p>

            <p>
                Third-party ad servers or ad networks uses technologies like
                cookies, JavaScript, or Web Beacons that are used in their
                respective advertisements and links that appear on GET Twin,
            ...
            <p>
                Note that GET Twin has no access to or control over these
            ...
            <p>
                GET Twin&apos;s Privacy Policy does not apply to other
            ...
            <p>
                GET Twin does not knowingly collect any Personal Identifiable
            ...
            <p>
                ...
                information that they shared and/or collect in GET Twin. This
